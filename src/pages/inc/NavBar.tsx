...
import {LayoutDashboard,Ticket,FileInput,LogOut,ChevronLeft,ChevronRight,Settings,Coins} from 'lucide-react';
...
const NAV_LINKS = [
  ...
  { to: '/SuperOuverture',    label: 'SuperOuverture',            icon: FileInput       },
